...
using ChinookWithAnnotations.Models.Chinook;

namespace ChinookWithAnnotations.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            ViewData["SupportRepId"] = new SelectList(_context.Employee, "EmployeeId", "FirstName");
            return View();
        }
